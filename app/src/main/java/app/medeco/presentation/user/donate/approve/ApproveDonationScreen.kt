...
import app.medeco.R
import app.medeco.data.remote.pharmacy.model.DonationDrug
import app.medeco.data.remote.pharmacy.model.DonationDrugItem
import app.medeco.data.remote.pharmacy.model.GetDonationData
import app.medeco.data.remote.pharmacy.model.GetDonationDto
import app.medeco.presentation.common.EventStatusDialog
...
import app.medeco.presentation.user.donate.components.DrugCard
...
fun ApproveDonationScreen(
    ...
    Scaffold(
        topBar = {
            MainTopAppBar(
                title = stringResource(R.string.collect_medications),
                onNavigateUp = {}
            )
        },
    ) { paddingValues ->
